...
if ( 'comments.php' == basename( $_SERVER['SCRIPT_FILENAME'] ) )
	die( __( 'Please do not load this page directly. Thanks!', 'basetheme' ) );
	...
	<div class="comments-wrap">
		...
		<div id="comments">
			...
			<?php if ( have_comments() ) : ?>
				...
				<h3 id="comments-number" class="comments-header"><?php comments_number( __( 'No Responses', 'basetheme' ), __( 'One Response', 'basetheme' ), __( '% Responses', 'basetheme' ) ); ?></h3>

...
<article id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
	...
	<?php if ( get_the_title() ) { ?>
				...
				<h2 class="post-title entry-title"><a href="<?php echo esc_url( basetheme_url_grabber() ); ?>" title="<?php the_title_attribute(); ?>"><?php printf( '%s <span class="meta-nav">&rarr;</span>', the_title( '', '', false ) ); ?></a></h2>

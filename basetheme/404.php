	...
	<div id="content" role="main">
		...
		<section class="hfeed">
			...
			<article id="post-0" class="<?php hybrid_entry_class(); ?>">
				...
				<h1 class="error-404-title entry-title"><?php _e( 'Not Found', 'basetheme' ); ?></h1>

				<div class="entry-content">

					<p>
					<?php printf( __( 'You tried going to %1$s, and it doesn\'t exist. ', 'basetheme' ), '<code>' . site_url( esc_url( $_SERVER['REQUEST_URI'] ) ) . '</code>' ); ?>
					</p>

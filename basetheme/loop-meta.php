...
<?php elseif ( is_search() ) : ?>
	...
	<header class="loop-meta">
		...
		<div class="loop-description">
			<p>
			<?php printf( __( 'You are browsing the search results for &quot;%1$s&quot;', 'basetheme' ), esc_attr( get_search_query() ) ); ?>
			</p>
		</div><!-- .loop-description -->
...
<?php elseif ( is_date() ) : ?>
	...
	<header class="loop-meta">
		<h1 class="loop-title"><?php _e( 'Archives by date', 'basetheme' ); ?></h1>

		<div class="loop-description">
			<p>
			<?php _e( 'You are browsing the site archives by date.', 'basetheme' ); ?>
			</p>
		</div><!-- .loop-description -->
...
<?php elseif ( is_archive() ) : ?>
	...
	<header class="loop-meta">
		...
		<h1 class="loop-title"><?php _e( 'Archives', 'basetheme' ); ?></h1>

		<div class="loop-description">
			<p>
			<?php _e( 'You are browsing the site archives.', 'basetheme' ); ?>
			</p>
		</div><!-- .loop-description -->
